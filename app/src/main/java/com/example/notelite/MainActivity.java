...
import com.example.notelite.auth.Login;
import com.example.notelite.auth.Register;
import com.example.notelite.model.Adapter;
import com.example.notelite.model.Note;
import com.example.notelite.note.AddNote;
import com.example.notelite.note.EditNote;
import com.example.notelite.note.NoteDetails;
        ...
        switch(item.getItemId()) {
            ...
            case R.id.shareapp:
                try {
                    ...
                    s.putExtra(Intent.EXTRA_SUBJECT,"NoteLite");
                    s.putExtra(Intent.EXTRA_TEXT,"http://play.google.com/store/apps/details?id="+getApplicationContext().getPackageName());
